...
import {createIungoWebPhoneUserAgent, IungoWebPhoneUserAgent} from './userAgent';
...
import {
    ...
    IungoWebPhoneSessionDescriptionHandlerFactoryOptions
...
export interface IungoWebPhoneRegistrationData {
    /** Sip Info received after registering device with Iungo */
...
export interface IungoWebPhoneOptions {
    /** Client ID of the Iungo Developer app */
    clientId?: string;
    ...
    onSession?: (session: IungoWebPhoneSession) => any;
     ...
     */
    sessionDescriptionHandlerFactoryOptions?: IungoWebPhoneSessionDescriptionHandlerFactoryOptions;
     ...
     *
     * default value `iungo-webPhone-uuid`
     */
    uuidKey?: string;
}

const defaultIungoWebPhoneOptions: IungoWebPhoneOptions = {
    autoStop: true,
    builtinEnabled: true,
    earlyMedia: false,
...
/**
 * IungoWebPhone class to initiate WebRTC calls
 */
export default class IungoWebPhone {
    /** IungoWebPhone version */
    ...
    /** IungoWebPhoneUserAgent instance */
    public userAgent: IungoWebPhoneUserAgent;

    /**
     * TODO: include 'IungoWebPhone' for all apps other than Chrome and Glip
     * TODO: parse wsservers from new api spec
     */
    public constructor(registrationData: IungoWebPhoneRegistrationData = {}, options: IungoWebPhoneOptions = {}) {
        options = Object.assign({}, defaultIungoWebPhoneOptions, options);
        ...
        const userAgentString =
            ...
            ` IUNGOWEBPHONE/${IungoWebPhone.version}`;
        ...
        const configuration: UserAgentOptions = {
            ...
            // IungoWebPhoneTransport will handle reconnection.
        ...
        this.userAgent = createIungoWebPhoneUserAgent(configuration, this.sipInfo, options, id);
    }
}
