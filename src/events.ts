export interface IungoWebPhoneEvents {
    /**  All IungoWebPhone events related to Transport */
    Transport: {
    ...
    /**  All IungoWebPhone events related to UserAgent */
    UserAgent: {
    ...
    /** All IungoWebPhone events related to Session */
    Session: {
...
/** @ignore */
export const Events: IungoWebPhoneEvents = {
    Transport: {
