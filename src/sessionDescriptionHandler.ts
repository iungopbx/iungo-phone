 ...
 */
export interface IungoWebPhoneSessionDescriptionHandlerConfiguration extends SessionDescriptionHandlerConfiguration {
 ...
 */
export interface IungoWebPhoneSessionDescriptionHandlerFactoryOptions extends SessionDescriptionHandlerFactoryOptions {
    /** Enable DSCP by setting packet priority in SDP */
    enableDscp?: boolean;
}
...
export class SessionDescriptionHandler implements SessionDescriptionHandlerDefinition {
    ...
    protected sessionDescriptionHandlerConfiguration?: IungoWebPhoneSessionDescriptionHandlerConfiguration;
    ...
    constructor(
        ...
        sessionDescriptionHandlerConfiguration?: IungoWebPhoneSessionDescriptionHandlerConfiguration
    ) {
...
export const defaultSessionDescriptionFactory = (
    session: Session,
    options?: IungoWebPhoneSessionDescriptionHandlerFactoryOptions
) => {
    ...
    const sessionDescriptionHandlerConfiguration: IungoWebPhoneSessionDescriptionHandlerConfiguration = {
        iceGatheringTimeout,
